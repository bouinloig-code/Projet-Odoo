...
gantt
    ...
    section Jour 1
    Analyse                          :crit, 12:00, 13:00
    Déploiement Docker + Odoo        :crit, 13:00, 15:00
    Configuration Odoo + Base produits + OF :crit, 16:00, 17:30

    section Jour 2
    Développement API Python (odoo.py)       :crit, 08:30, 09:30
    PAUSE                                   :milestone, 09:30, 10:00
    Développement IHM Tkinter (main.py)     :active, 10:00, 12:00
    Tests API / IHM et ajustements          :active, 11:00, 12:00
    PAUSE                                   :milestone, 12:00, 13:00
    Structuration du dépôt GIT              :done, 13:00, 14:00
    Rédaction des fichiers Markdown         :active, 13:00, 15:00
    PAUSE                                   :milestone, 15:00, 15:30
